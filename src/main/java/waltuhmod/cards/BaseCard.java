...
import waltuhmod.Waltuhmod;
import waltuhmod.util.CardStats;
import waltuhmod.util.TriFunction;
...
import static waltuhmod.util.GeneralUtils.removePrefix;
import static waltuhmod.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return Waltuhmod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    Waltuhmod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
