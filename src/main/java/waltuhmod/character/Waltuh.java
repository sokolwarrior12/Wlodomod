...
import waltuhmod.cards.Defend;
import waltuhmod.cards.ExcelOS;
import waltuhmod.cards.Strike;
import waltuhmod.relics.PinkLunchBox;

import java.util.ArrayList;

import static waltuhmod.Waltuhmod.characterPath;
import static waltuhmod.Waltuhmod.makeID;

public class Waltuh extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("waltuh"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass WALTUHP;
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new Waltuh(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
